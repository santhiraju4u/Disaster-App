...
const serverUrl =
  "http://disaster-resiliency-app-grateful-hyrax-mt.eu-gb.mybluemix.net";
...
const ChatScreen = function ({ navigation }) {
        ...
        getSession()
          ...
          .catch((err) => {
            ...
            addMessages([
              {
                text:
                  "ERROR: Please try again. If the poblem persists contact an administrator.",
              },
            ]);
          });
      });
